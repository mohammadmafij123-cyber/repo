...
st.markdown("""
    <div class='nexus-header'>
        ...
        <div class='system-status'>● ENGINE ALIVE | FEED: LIVE BINANCE CORE TRADINGVIEW</div>
    </div>
""", unsafe_allow_html=True)
...
if menu == "🏠 Execution Terminal":
    ...
    with left_layout:
        st.write("📈 **Official Binance Feed Terminal (Zero-Refresh Absolute Smooth Motion)**")
        
        # বিশ্বমানের লাইভ ট্রেডিংভিউ উইজেট এমবেড কোড (যা কোনো এক্সটার্নাল স্ক্রিপ্ট ছাড়া সরাসরি ব্রাউজারে রান করবে)
        tradingview_embed = """
        <iframe src="https://tradingview.com" 
                width="100%" height="380" frameborder="0" allowtransparency="true" scrolling="no" allowfullscreen style="border-radius:6px; border: 1px solid #24292e;"></iframe>
        """
        # এটি সম্পূর্ণ জিরো-রিফ্রেশে ব্যাকগ্রাউন্ডে নিজের ভেতরে ক্যান্ডেল নড়াচড়া করাবে
        components.html(tradingview_embed, height=395)
